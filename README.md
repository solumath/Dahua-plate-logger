...
Dahua TrafficJunction camera event listener. Streams plate detection events and logs them to daily CSV files.
...
| `spz_logger.log` | Application log with rotating backup (5 MB × 3) |
...
OUTPUT_DIR=   # optional, defaults to plates/ next to the exe
LOG_FILE=     # optional, defaults to spz_logger.log next to the exe
```
